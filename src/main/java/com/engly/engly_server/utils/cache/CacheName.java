...
public class CacheName {
    ...
    public static final List<String> CACHES = Arrays.asList(
            ...
            USER_ENTITY_BY_EMAIL, ROOMS_BY_CATEGORY, ROOM_ENTITY_ID, ROOMS_BY_CRITERIA,
            CATEGORY_ID, CATEGORY_ENTITY_ID, CATEGORY_NAME, ALL_CATEGORIES, MESSAGE_ID, USER_BY_EMAIL_DTO,
            MESSAGES_BY_ROOM, MESSAGES_BY_ROOM_NATIVE, MESSAGE_COUNT_BY_ROOM, MESSAGES_BY_CRITERIA,
