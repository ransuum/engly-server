...
public record GoogleRedirectUrl(String frontendUrl, String accessToken, String refreshToken, String username) {
    ...
    public String getRedirectUrl() {
        return String.format("%s/google-auth/callback?access_token=%s&refresh_token=%s&expires_in=%d&token_type=Bearer&username=%s",
                frontendUrl, accessToken, refreshToken, 15 * 60, username);
    }
}
