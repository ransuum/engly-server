...
@Getter
public enum Roles {
    ROLE_ADMIN(Set.of("READ", "WRITE", "DELETE", "CREATE_CATEGORY", "UPDATE_CATEGORY", "DELETE_CATEGORY", "ADMIN")),
    ROLE_MANAGER(Set.of("READ", "WRITE", "DELETE")),
    ROLE_USER(Set.of("READ", "WRITE")),
    ROLE_GOOGLE(Set.of("ADDITIONAL_INFO")),
    ROLE_SYSADMIN(Set.of("READ", "WRITE", "DELETE", "CREATE_CATEGORY", "UPDATE_CATEGORY", "DELETE_CATEGORY")),
